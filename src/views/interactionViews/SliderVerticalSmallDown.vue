<template>
  ...
  const IMAGE_PATH = '/siggraph_demo/view_svs.png'; // Replace with your image path
  const DRAWING_KEY = 'slider_vertical_small_down'; // Global variable for the key under which the drawing path will be saved
