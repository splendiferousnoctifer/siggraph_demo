<template>
  ...
  const IMAGE_PATH = '/siggraph_demo/view_srl.png'; // Replace with your image path
  const DRAWING_KEY = 'slider_radial_large_counter'; // Global variable for the key under which the drawing path will be saved
