<template>
    <div class="drawing-page">
      <h3>Slide around the circle clockwise &#8635</h3>
  ...
  const DRAWING_KEY = 'slider_radial_large_clockwise'; // Global variable for the key under which the drawing path will be saved
