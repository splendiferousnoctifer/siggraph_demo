<template>
  ...
  const IMAGE_PATH = '/siggraph_demo/view_bl.png'; // Replace with your image path
  const DRAWING_KEY = 'button_large'; // Global variable for the key under which the drawing path will be saved
