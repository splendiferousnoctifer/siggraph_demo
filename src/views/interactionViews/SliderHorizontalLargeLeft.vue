<template>
  ...
  const IMAGE_PATH = '/siggraph_demo/view_shl.png'; // Replace with your image path
  const DRAWING_KEY = 'slider_horizontal_large_left'; // Global variable for the key under which the drawing path will be saved
