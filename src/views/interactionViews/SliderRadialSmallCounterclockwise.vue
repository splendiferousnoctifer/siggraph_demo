<template>
    <div class="drawing-page">
      <h3>Slide around the circle counterclockwise &#8634</h3>
  ...
  const IMAGE_PATH = '/siggraph_demo/view_srs.png'; // Replace with your image path
  const DRAWING_KEY = 'slider_radial_small_counter'; // Global variable for the key under which the drawing path will be saved
